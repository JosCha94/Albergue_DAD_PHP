                            ...
                            <?php foreach ($adop_datos as $key => $value) : ?>
                                <div class="accordion-body">
                                    <ul class="borde p-3">
                                        ...
                                        <li class="mx-5">Estado de la adopción :<strong><?php if ($value['adop_estado'] == 'Rechazada') {
                                                                                            echo 'Lo sentimos, su solicitud fue rechazada o el perrito fue adoptado por otra persona';
                                                                                        } else {
                                                                                            echo $value['adop_estado'];
                                                                                        } ?></strong></li>
