...
<div class="container adop-body mt-5">
    <div class="row">
        <div class="col-md-3 sidebar-filter">
            ...
            <div class="form-check mt-2 mb-2 pl-2">
                <div class="custom-control custom-checkbox">
                    <input type="radio" class="form-check-input filtroA" id="category-1" edad1="0" edad2="1" edad3="2" name="filtro">
                    <label class="form-check-label" for="category-1">De 0 a 2 años</label>
                </div>
            </div>
            <div class=" form-check mt-2 mb-2 pl-2">
                <div class="custom-control custom-checkbox">
                    <input type="radio" class="form-check-input filtroA" id="category-2" name="filtro" edad1="3" edad2="4" edad3="5">
                    <label class="form-check-label" for="category-2">De 3 a 5 años</label>
                </div>
            </div>
            <div class="form-check mt-2 mb-2 pl-2">
                <div class="custom-control custom-checkbox">
                    <input type="radio" class="form-check-input filtroA" id="category-3" name="filtro" edad1="6" edad2="7" edad3="8">
                    <label class="form-check-label" for="category-3">De 6 a 8 años</label>
                </div>
            </div>
            <div class="form-check mt-2 mb-2 pl-2">
                <div class="custom-control custom-checkbox">
                    <input type="radio" class="form-check-input filtroA" id="category-3" name="filtro" edad1="9" edad2="10" edad3="11">
